...
function flat(arr) {
  ...
  try {
    for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
      ...
      Array.isArray(item2) && depth > 0 ? flatArray = flatArray.concat(flat(item2, depth - 1)) : flatArray.push(item2);
    }
  } catch (err) {
    _iterator3.e(err);
  } finally {
...
function itemOrItemsBallsMacroName(itemOrItems) {
  ...
  return overlappingItemNames.includes(item2.name) ? item2.id.toFixed(0) : item2.name;
}
...
function canEquipItemCount() {
  ...
  }) || (cachedStats = stats, cachedCanEquipItemCount = import_kolmafia7.Item.all().filter(function(item2) {
    return (0, import_kolmafia7.canEquip)(item2);
...
function applyCached(entry, options) {
  ...
  if (outfitName) {
    ...
    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
        var _step3$value = _slicedToArray2(_step3.value, 2), slot = _step3$value[0], item2 = _step3$value[1];
        (0, import_kolmafia7.equippedItem)(slot) !== item2 && (0, import_kolmafia7.availableAmount)(item2) > 0 && (0, import_kolmafia7.equip)(slot, item2);
      }
    } catch (err) {
      _iterator3.e(err);
    } finally {
  ...
  try {
    for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
      var slotGroup = _step4.value, desiredSlots = slotGroup.map(function(slot) {
        ...
        var _ref3 = _slicedToArray2(_ref2, 2), item2 = _ref3[1];
        return item2 !== null;
      }), desiredSet = desiredSlots.map(function(_ref4) {
        var _ref5 = _slicedToArray2(_ref4, 2), item2 = _ref5[1];
        return item2;
...
function maximizeCached(objectives) {
  var options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, fullOptions = mergeMaximizeOptions(defaultMaximizeOptions, options), forceEquip = fullOptions.forceEquip, preventEquip = fullOptions.preventEquip, bonusEquip = fullOptions.bonusEquip, onlySlot = fullOptions.onlySlot, preventSlot = fullOptions.preventSlot, forceUpdate = fullOptions.forceUpdate, objective = _toConsumableArray3(new Set([].concat(_toConsumableArray3(objectives.sort()), _toConsumableArray3(forceEquip.map(function(item2) {
    return '"equip '.concat(toMaximizerName(item2), '"');
    ...
    var _ref11 = _slicedToArray2(_ref10, 2), item2 = _ref11[0], bonus = _ref11[1];
    return "".concat(Math.round(bonus * 100) / 100, ' "bonus ').concat(toMaximizerName(item2), '"');
...
var item = $item(_templateObject51 || (_templateObject51 = _taggedTemplateLiteral3(["Source terminal"])));
function have2() {
  return haveInCampground(item);
}
var Buffs = {
  Items: $effect(_templateObject211 || (_templateObject211 = _taggedTemplateLiteral3(["items.enh"]))),
  Meat: $effect(_templateObject310 || (_templateObject310 = _taggedTemplateLiteral3(["meat.enh"]))),
  Init: $effect(_templateObject410 || (_templateObject410 = _taggedTemplateLiteral3(["init.enh"]))),
  Critical: $effect(_templateObject52 || (_templateObject52 = _taggedTemplateLiteral3(["critical.enh"]))),
  Damage: $effect(_templateObject62 || (_templateObject62 = _taggedTemplateLiteral3(["damage.enh"]))),
  Substats: $effect(_templateObject72 || (_templateObject72 = _taggedTemplateLiteral3(["substats.enh"])))
};
...
var RolloverBuffs = {
  /** +5 Familiar Weight */
  Familiar: $effect(_templateObject82 || (_templateObject82 = _taggedTemplateLiteral3(["familiar.enq"]))),
  /** +25 ML */
  Monsters: $effect(_templateObject93 || (_templateObject93 = _taggedTemplateLiteral3(["monsters.enq"]))),
  /** +5 Prismatic Resistance */
  Protect: $effect(_templateObject103 || (_templateObject103 = _taggedTemplateLiteral3(["protect.enq"]))),
  /** +100% Muscle, +100% Mysticality, +100% Moxie */
  Stats: $effect(_templateObject113 || (_templateObject113 = _taggedTemplateLiteral3(["stats.enq"])))
};
...
var Skills = {
  ...
  Extract: $skill(_templateObject123 || (_templateObject123 = _taggedTemplateLiteral3(["Extract"]))),
  /** Stagger and create a wandering monster 1-3 times per day */
  Digitize: $skill(_templateObject133 || (_templateObject133 = _taggedTemplateLiteral3(["Digitize"]))),
  /** Stagger and deal 25% of enemy HP in damage once per combat */
  Compress: $skill(_templateObject143 || (_templateObject143 = _taggedTemplateLiteral3(["Compress"]))),
  /** Double monster's HP, attack, defence, attacks per round and item drops once per fight and once per day (five in The Source) */
  Duplicate: $skill(_templateObject153 || (_templateObject153 = _taggedTemplateLiteral3(["Duplicate"]))),
  /** Causes government agent/Source Agent wanderer next turn once per combat and three times per day */
  Portscan: $skill(_templateObject163 || (_templateObject163 = _taggedTemplateLiteral3(["Portscan"]))),
  /** Increase Max MP by 100% and recover 1000 MP once per combat with a 30 turn cooldown */
  Turbo: $skill(_templateObject173 || (_templateObject173 = _taggedTemplateLiteral3(["Turbo"])))
};
...
var Items = /* @__PURE__ */ new Map([[$item(_templateObject183 || (_templateObject183 = _taggedTemplateLiteral3(["browser cookie"]))), "food.ext"], [$item(_templateObject193 || (_templateObject193 = _taggedTemplateLiteral3(["hacked gibson"]))), "booze.ext"], [$item(_templateObject203 || (_templateObject203 = _taggedTemplateLiteral3(["Source shades"]))), "goggles.ext"], [$item(_templateObject213 || (_templateObject213 = _taggedTemplateLiteral3(["Source terminal GRAM chip"]))), "gram.ext"], [$item(_templateObject223 || (_templateObject223 = _taggedTemplateLiteral3(["Source terminal PRAM chip"]))), "pram.ext"], [$item(_templateObject233 || (_templateObject233 = _taggedTemplateLiteral3(["Source terminal SPAM chip"]))), "spam.ext"], [$item(_templateObject243 || (_templateObject243 = _taggedTemplateLiteral3(["Source terminal CRAM chip"]))), "cram.ext"], [$item(_templateObject253 || (_templateObject253 = _taggedTemplateLiteral3(["Source terminal DRAM chip"]))), "dram.ext"], [$item(_templateObject263 || (_templateObject263 = _taggedTemplateLiteral3(["Source terminal TRAM chip"]))), "tram.ext"], [$item(_templateObject273 || (_templateObject273 = _taggedTemplateLiteral3(["software bug"]))), "familiar.ext"]]);
function extrude(item2) {
  var fileName = Items.get(item2);
...
var CombatStrategy = /* @__PURE__ */ function() {
  ...
  return _createClass8(CombatResources2, [{
    ...
    value: function(action) {
      ...
      if (resource !== void 0)
        return resource.do instanceof import_kolmafia9.Item ? new Macro().item(resource.do) : resource.do instanceof import_kolmafia9.Skill ? new Macro().skill(resource.do) : undelay(resource.do);
    }
  }]), CombatResources2;
}();
...
var weaponHands = function(i) {
  ...
  return _createClass9(Outfit2, [{
    ...
    value: function(item2) {
      var _a;
      return !(!((_a = this.avoid) === null || _a === void 0) && _a.includes(item2) || !have(item2, this.equippedAmount(item2) + 1) || (0, import_kolmafia10.booleanModifier)(item2, "Single Equip") && this.equippedAmount(item2) > 0);
    }
    /**
    ...
    value: function(item2, slot) {
      return slot === void 0 ? this.equippedAmount(item2) > 0 : this.equips.get(slot) === item2;
    }
  }, {
    key: "equipItemNone",
    value: function(item2, slot) {
    ...
    value: function(item2, slot) {
      if ($slots(_templateObject53 || (_templateObject53 = _taggedTemplateLiteral4(["acc1, acc2, acc3"]))).includes((0, import_kolmafia10.toSlot)(item2)) || slot !== void 0 && slot !== (0, import_kolmafia10.toSlot)(item2) || this.equips.has((0, import_kolmafia10.toSlot)(item2)))
        return !1;
      switch ((0, import_kolmafia10.toSlot)(item2)) {
        ...
        case $slot(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral4(["familiar"]))):
          if (this.familiar !== void 0 && !(0, import_kolmafia10.canEquip)(this.familiar, item2))
            return !1;
      }
      return (0, import_kolmafia10.toSlot)(item2) !== $slot(_templateObject63 || (_templateObject63 = _taggedTemplateLiteral4(["familiar"]))) && !(0, import_kolmafia10.canEquip)(item2) ? !1 : (this.equips.set((0, import_kolmafia10.toSlot)(item2), item2), !0);
    }
  }, {
    key: "equipAccessory",
    value: function(item2, slot) {
      var _this = this;
      if (![void 0].concat(_toConsumableArray5($slots(_templateObject73 || (_templateObject73 = _taggedTemplateLiteral4(["acc1, acc2, acc3"]))))).includes(slot) || (0, import_kolmafia10.toSlot)(item2) !== $slot(_templateObject83 || (_templateObject83 = _taggedTemplateLiteral4(["acc1"]))) || !(0, import_kolmafia10.canEquip)(item2))
        return !1;
      if (slot === void 0) {
    ...
    value: function(item2, slot) {
      return ![void 0, $slot(_templateObject104 || (_templateObject104 = _taggedTemplateLiteral4(["off-hand"])))].includes(slot) || (0, import_kolmafia10.toSlot)(item2) !== $slot(_templateObject114 || (_templateObject114 = _taggedTemplateLiteral4(["weapon"]))) || this.equips.has($slot(_templateObject124 || (_templateObject124 = _taggedTemplateLiteral4(["weapon"])))) && weaponHands(this.equips.get($slot(_templateObject134 || (_templateObject134 = _taggedTemplateLiteral4(["weapon"]))))) !== 1 || this.equips.has($slot(_templateObject144 || (_templateObject144 = _taggedTemplateLiteral4(["off-hand"])))) || !have($skill(_templateObject154 || (_templateObject154 = _taggedTemplateLiteral4(["Double-Fisted Skull Smashing"])))) || weaponHands(item2) !== 1 || !(0, import_kolmafia10.canEquip)(item2) ? !1 : (this.equips.set($slot(_templateObject164 || (_templateObject164 = _taggedTemplateLiteral4(["off-hand"]))), item2), !0);
    }
  }, {
    ...
    value: function(item2) {
      var _a;
      return (_a = this.bonuses.get(item2)) !== null && _a !== void 0 ? _a : 0;
    }
    /**
    ...
    key: "applyBonus",
    value: function(item2, value, reducer) {
      var previous = this.getBonus(item2);
      return this.setBonus(item2, reducer(value, previous));
    }
    /**
    ...
    key: "setBonus",
    value: function(item2, value) {
      return this.bonuses.set(item2, value), value;
    }
    /**
    ...
    key: "addBonus",
    value: function(item2, value) {
      return this.applyBonus(item2, value, function(a, b) {
        return a + b;
      });
    }
    /**
    ...
    value: function(items, reducer) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done; ) {
          var _step$value = _slicedToArray3(_step.value, 2), item2 = _step$value[0], value = _step$value[1];
          this.applyBonus(item2, value, reducer);
        }
      } catch (err) {
        _iterator.e(err);
      } finally {
    ...
    value: function(item2, slot) {
      if (![void 0, $slot(_templateObject215 || (_templateObject215 = _taggedTemplateLiteral4(["familiar"])))].includes(slot) || this.equips.has($slot(_templateObject224 || (_templateObject224 = _taggedTemplateLiteral4(["familiar"])))) || (0, import_kolmafia10.booleanModifier)(item2, "Single Equip"))
        return !1;
      var familiar = this.getHoldingFamiliar(item2);
      return familiar === void 0 || !this.equip(familiar) ? !1 : (this.equips.set($slot(_templateObject234 || (_templateObject234 = _taggedTemplateLiteral4(["familiar"]))), item2), !0);
    }
  }, {
    key: "equipItem",
    value: function(item2, slot) {
    ...
    value: function(refreshed) {
      ...
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
          ...
          (targetEquipment.includes((0, import_kolmafia10.equippedItem)(slot)) && this.equips.get(slot) !== (0, import_kolmafia10.equippedItem)(slot) || this.avoid.includes((0, import_kolmafia10.equippedItem)(slot)) || slot === $slot(_templateObject492 || (_templateObject492 = _taggedTemplateLiteral4(["weapon"]))) && weaponHands((0, import_kolmafia10.equippedItem)(slot)) !== 1 && this.equips.has($slot(_templateObject502 || (_templateObject502 = _taggedTemplateLiteral4(["offhand"])))) && !this.equips.has($slot(_templateObject512 || (_templateObject512 = _taggedTemplateLiteral4(["weapon"]))))) && (0, import_kolmafia10.equip)(slot, $item.none);
        }
      } catch (err) {
        _iterator3.e(err);
      } finally {
      ...
      if (applyModes(modes), bjorn && (0, import_kolmafia10.haveEquipped)($item(_templateObject432 || (_templateObject432 = _taggedTemplateLiteral4(["Buddy Bjorn"])))) && ((0, import_kolmafia10.myEnthronedFamiliar)() === bjorn && (0, import_kolmafia10.enthroneFamiliar)($familiar.none), (0, import_kolmafia10.myBjornedFamiliar)() !== bjorn && (0, import_kolmafia10.bjornifyFamiliar)(bjorn)), crown && (0, import_kolmafia10.haveEquipped)($item(_templateObject442 || (_templateObject442 = _taggedTemplateLiteral4(["Crown of Thrones"])))) && ((0, import_kolmafia10.myBjornedFamiliar)() === crown && (0, import_kolmafia10.bjornifyFamiliar)($familiar.none), (0, import_kolmafia10.myEnthronedFamiliar)() !== crown && (0, import_kolmafia10.enthroneFamiliar)(crown)), this.familiar !== void 0 && (0, import_kolmafia10.myFamiliar)() !== this.familiar)
      ...
      for (var _i5 = 0, _arr2 = [[$slot(_templateObject452 || (_templateObject452 = _taggedTemplateLiteral4(["buddy-bjorn"]))), $item(_templateObject462 || (_templateObject462 = _taggedTemplateLiteral4(["Buddy Bjorn"]))), import_kolmafia10.myBjornedFamiliar], [$slot(_templateObject472 || (_templateObject472 = _taggedTemplateLiteral4(["crown-of-thrones"]))), $item(_templateObject482 || (_templateObject482 = _taggedTemplateLiteral4(["Crown of Thrones"]))), import_kolmafia10.myEnthronedFamiliar]]; _i5 < _arr2.length; _i5++) {
    ...
    value: function() {
      ...
      for (var _i6 = 0, _outfitSlots2 = outfitSlots; _i6 < _outfitSlots2.length; _i6++) {
        var slotName = _outfitSlots2[_i6], entry = this.equips.get((_a = (/* @__PURE__ */ new Map([["famequip", $slot(_templateObject522 || (_templateObject522 = _taggedTemplateLiteral4(["familiar"])))], ["offhand", $slot(_templateObject532 || (_templateObject532 = _taggedTemplateLiteral4(["off-hand"])))]])).get(slotName)) !== null && _a !== void 0 ? _a : (0, import_kolmafia10.toSlot)(slotName));
    ...
    value: function() {
      ...
      for (var _i7 = 0, _outfitSlots3 = outfitSlots; _i7 < _outfitSlots3.length; _i7++) {
        var slotName = _outfitSlots3[_i7], slot = (_a = (/* @__PURE__ */ new Map([["famequip", $slot(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral4(["familiar"])))], ["offhand", $slot(_templateObject57 || (_templateObject57 = _taggedTemplateLiteral4(["off-hand"])))]])).get(slotName)) !== null && _a !== void 0 ? _a : (0, import_kolmafia10.toSlot)(slotName), item2 = (0, import_kolmafia10.equippedItem)(slot);
        if (!outfit2.equip(item2, slot))
          throw "Failed to create outfit from current state (expected: ".concat(slot, " ").concat(item2, ")");
      }
      return (0, import_kolmafia10.haveEquipped)($item(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral4(["Crown of Thrones"])))) && outfit2.riders.set($slot(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral4(["crown-of-thrones"]))), (0, import_kolmafia10.myEnthronedFamiliar)()), (0, import_kolmafia10.haveEquipped)($item(_templateObject60 || (_templateObject60 = _taggedTemplateLiteral4(["Buddy Bjorn"])))) && outfit2.riders.set($slot(_templateObject61 || (_templateObject61 = _taggedTemplateLiteral4(["buddy-bjorn"]))), (0, import_kolmafia10.myBjornedFamiliar)()), outfit2.setModes(getCurrentModes2()), outfit2;
    }
  }, {
    key: "from",
    value: function(spec) {
...
var grimoireCCS = "grimoire_macro", Engine = /* @__PURE__ */ function() {
  ...
  return _createClass10(Engine2, [{
    ...
    value: function(task, task_combat, task_resources) {
      var _a, macro = task_combat.compile(task_resources, (_a = this.options) === null || _a === void 0 ? void 0 : _a.combat_defaults, task.do instanceof import_kolmafia11.Location ? task.do : void 0);
    ...
    value: function(task) {
      ...
      for (result instanceof import_kolmafia11.Location && (0, import_kolmafia11.adv1)(result, -1, ""), (0, import_kolmafia11.runCombat)(); (0, import_kolmafia11.inMultiFight)(); )
        (0, import_kolmafia11.runCombat)();
    ...
    value: function(task, postcondition) {
      ...
      if (task.limit) {
        ...
        if (!task.completed()) {
          ...
          if (task.limit.turns && task.do instanceof import_kolmafia11.Location && task.do.turnsSpent >= task.limit.turns)
...
var wanderingNCs = /* @__PURE__ */ new Set([
  ...
  ["The Horror...", $locations(_templateObject216 || (_templateObject216 = _taggedTemplateLiteral5(["Frat House"])))]
...
// src/lib/args.ts
init_kolmafia_polyfill();
var args = Args.create("upgradeSource", "A script to check for any missing Source Terminal upgrades, and extrude/install them.", {
  sim: Args.flag({
    setting: "",
    default: !1,
...
// src/main.ts
var import_kolmafia12 = require("kolmafia"), _templateObject65, _templateObject217, _templateObject314, _templateObject413, _templateObject510, _templateObject66, _templateObject74, _templateObject84, _templateObject95;
function _taggedTemplateLiteral6(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
var enhFiles = $items(_templateObject65 || (_templateObject65 = _taggedTemplateLiteral6(["Source terminal file: critical.enh, Source terminal file: damage.enh, Source terminal file: substats.enh"]))), enqFiles = $items(_templateObject217 || (_templateObject217 = _taggedTemplateLiteral6(["Source terminal file: protect.enq, Source terminal file: stats.enq"]))), eduFiles = $items(_templateObject314 || (_templateObject314 = _taggedTemplateLiteral6(["Source terminal file: compress.edu, Source terminal file: duplicate.edu, Source terminal file: portscan.edu, Source terminal file: turbo.edu"]))), extFiles = $items(_templateObject413 || (_templateObject413 = _taggedTemplateLiteral6(["Source terminal file: gram.ext, Source terminal file: pram.ext, Source terminal file: spam.ext, Source terminal file: cram.ext, Source terminal file: dram.ext, Source terminal file: tram.ext, Source terminal file: familiar.ext"]))), singleUseChips = $items(_templateObject510 || (_templateObject510 = _taggedTemplateLiteral6(["Source terminal CRAM chip, Source terminal DRAM chip, Source terminal TRAM chip, Source terminal INGRAM chip, Source terminal DIAGRAM chip, Source terminal ASHRAM chip, Source terminal SCRAM chip, Source terminal TRIGRAM chip"]))), sourceEssence = $item(_templateObject66 || (_templateObject66 = _taggedTemplateLiteral6(["Source essence"]))), autoBuyLimit = get("autoBuyPriceLimit");
function main(command) {
  if (Args.fill(args, command), args.help) {
    Args.showHelp(args);
    return;
  }
  (0, import_kolmafia12.print)("Attempting to upgrade Source Terminal...", "blue"), enhance2(), enquiry2(), educate2(), extrude2();
  var installedChips = get("sourceTerminalChips").split(",");
  singleUseChips.forEach(function(chip) {
    var chipName = chip.name.split(" ")[2];
    installedChips.includes(chipName) || (args.sim ? ((0, import_kolmafia12.print)("Sim: Buying 1 ".concat(chip, " @").concat(autoBuyLimit)), (0, import_kolmafia12.print)("Sim: Using 1 ".concat(chip))) : (0, import_kolmafia12.buy)(1, chip, autoBuyLimit) !== 0 && (0, import_kolmafia12.use)(1, chip));
  });
  var gramCount = get("sourceTerminalGram");
  buyAndUseMultiChips($item(_templateObject74 || (_templateObject74 = _taggedTemplateLiteral6(["Source terminal GRAM chip"]))), gramCount);
  var pramCount = get("sourceTerminalPram");
  buyAndUseMultiChips($item(_templateObject84 || (_templateObject84 = _taggedTemplateLiteral6(["Source terminal PRAM chip"]))), pramCount);
  var spamCount = get("sourceTerminalSpam");
  buyAndUseMultiChips($item(_templateObject95 || (_templateObject95 = _taggedTemplateLiteral6(["Source terminal SPAM chip"]))), spamCount);
}
function enhance2() {
...
function buyAndUseFiles(files, names) {
  files.forEach(function(file) {
    var fileName = file.name.split(" ")[3];
    names.includes(fileName) || (args.sim ? ((0, import_kolmafia12.print)("Sim: Buying 1 ".concat(file, " @").concat(autoBuyLimit)), (0, import_kolmafia12.print)("Sim: Using 1 ".concat(file))) : (0, import_kolmafia12.buy)(1, file, autoBuyLimit) !== 0 && (0, import_kolmafia12.use)(1, file));
  });
}
function buyAndUseMultiChips(chip, currentCount) {
  if (get("_sourceTerminalExtrudes") !== 3 && currentCount !== 10 && !((0, import_kolmafia12.itemAmount)(sourceEssence) < 100)) {
    for (var chipsNeeded = Math.min(3, 10 - currentCount), i = 0; i < chipsNeeded && (0, import_kolmafia12.itemAmount)(sourceEssence) >= 100 && get("_sourceTerminalExtrudes") < 3; )
      args.sim ? (0, import_kolmafia12.print)("Sim: extruding a ".concat(chip)) : SourceTerminal_exports.extrude(chip), i++;
    args.sim ? (0, import_kolmafia12.print)("Sim: using ".concat(i, " ").concat(i > 1 ? chip.plural : chip.name)) : (0, import_kolmafia12.use)(i, chip);
  }
}
